...
public class UI_HealthCircle : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _mpSliderFill = Util.FindChild<Image>(_mpSlider.gameObject, "Fill", true, true);
