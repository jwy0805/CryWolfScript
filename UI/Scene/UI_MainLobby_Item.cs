...
public partial class UI_MainLobby
{
    ...
    {
        var cardPacket = new GetOwnedCardsPacketRequired { UserAccount = Managers.User.UserAccount };
        var cardTask = Managers.Web.SendPostRequestAsync<GetOwnedCardsPacketResponse>("Collection/GetCards", cardPacket);
        
        var deckPacket = new GetInitDeckPacketRequired { UserAccount = Managers.User.UserAccount };
    ...
    public void UpdateDeck(Card oldCard, Card newCard)
    {
        ...
        {
            UserAccount = Managers.User.UserAccount,
            DeckId = deck.DeckId,
